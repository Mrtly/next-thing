...
export default function SideNav() {
  ...
  return (
    <nav className="shadow-md font-ubuntu border-r border-slate-300 px-4 lg:px-10 text-lg">
      <div className="font-medium text-yin text-xl mt-8 mb-4">Components</div>
      <SideNavLink to="/" displayText="Demo"/>
      <Divider/>
      <div className="font-medium text-yin text-xl mt-4 mb-4 whitespace-nowrap">Data Viz Samples</div>
