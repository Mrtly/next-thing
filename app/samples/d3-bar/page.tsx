...
export default function D3Bar() {
  ...
  useEffect( () => {
    ...
    svg.select(".x-axis")
      ...
      //@ts-ignore
      .call(xAxis)
      .attr("class", "font-ubuntu text-md text-coral");
    ...
    svg.select(".y-axis")
      ...
      //@ts-ignore
      .call(yAxis)
      .attr("class", "font-ubuntu text-md text-yin");
    ...
    <Card>
      <div className="px-8 py-4">
        ...
        <div className="flex items-center justify-around">
            <Button small color="violet" onClick={ () => setData(dataSet.map( value => value+ 5))}> Increase </Button>
