...
export default function SideNav() {
  ...
  return (
    <nav className="shadow-md bg-ground border-r border-slate-300 px-4 lg:px-6 text-lg">
      <div className="font-medium text-wood my-4 whitespace-nowrap">Data Viz Samples</div>
      ...
      <Divider/>
      <div className="font-medium text-wood my-4">Components</div>
